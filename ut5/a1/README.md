...
|:-----:|:---------------------:|:----------------------:|
|Usuario| Persona que usa la aplicación|Registrarse, Iniciar Session,Consultar canchasdisponibles|
|Administrador|Persona que administra aplicacion|Añadir instlaciones,Listar a los usuarios, bloquear a usuarios|
|       |                       |                        |
|       |                       |                        |
|       |                       |                        |
|       |                       |                        |
